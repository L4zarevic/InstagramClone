    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.imgShare:
                ...
                //Verification that the user has given permission to access the data
            ...
            case R.id.btnShareImage:
                ...
                //Checking is the image is selected
                if (receivedImageBitmap != null) {

                    //Checking if a description is entered
                    if (edtDescription.getText().toString().trim().equals("")) {
                        ...
                        //Convert photos to bytes and upload to server
                        ...
                        parseObject.put("image_des", edtDescription.getText().toString().trim());
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if (e == null) {
                                    FancyToast.makeText(getContext(), "Photo is uploaded", Toast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
                                } else {
                    ...
                    FancyToast.makeText(getContext(), "Error: You must selected the image", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                }
                break;
        }
